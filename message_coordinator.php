...
<body>
                    ...
                    <div class="contacts-list">
                        ...
                        try {
                            ...
                            foreach ($coordinators as &$coordinator) {
                                $stmt = $conn->prepare("
                                    ...
                                    LIMIT 1
                                ");
                                $stmt->execute([$admin_id, $coordinator['id']]);
                        ...
                        if (count($coordinators) > 0) {
                            foreach ($coordinators as $coordinator) {
                                ...
                                echo "<div class='contact-item' data-admin-id='{$coordinator['id']}'>";
                            ...
                            echo '<div class="no-contacts">No coordinators found</div>';
                        }
                        ?>
                    </div>
                </div>
    ...
    $(document).ready(function() {
        ...
        // Function to load messages for a coordinator
        function loadCoordinatorMessages(adminId) {
            if (!adminId) return;
            ...
            $.ajax({
                ...
                type: 'GET',
                data: { coordinator_id: adminId },
                dataType: 'json',
                success: function(response) {
                    console.log('Messages loaded:', response);
                    
                    // Check if response has data and messages array
        ...
        function sendMessage() {
            ...
            $.ajax({
                ...
                type: 'POST',
                data: {
                    coordinator_id: currentStudentId,
                    content: message
                },
                dataType: 'json',
                success: function(response) {
    ...
    if (typeof Toastify !== 'undefined') {
        ...
        function selectConversation(adminId, adminName) {
            ...
            loadCoordinatorMessages(adminId);
            updateFileCounts();
